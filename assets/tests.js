...
define('job-search-ember/tests/integration/components/job-info-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | job-info', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "fNQV+IpR",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"job-info\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "awedk1rW",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"job-info\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('job-search-ember/tests/integration/helpers/is-current-page-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Helper | isCurrentPage', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "zqmasqii",
        "block": "{\"symbols\":[],\"statements\":[[1,[27,\"is-current-page\",[[23,[\"inputValue\"]]],null],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('job-search-ember/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/job-info.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/job-info.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('controllers/job-info.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/job-info.js should pass ESLint\n\n8:14 - Use import { computed } from \'@ember/object\'; instead of using Ember.computed (ember/new-module-imports)\n8:14 - \'Ember\' is not defined. (no-undef)');
  });

  QUnit.test('controllers/jobs.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/jobs.js should pass ESLint\n\n7:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n9:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n9:17 - Use import { computed } from \'@ember/object\'; instead of using Ember.computed (ember/new-module-imports)\n9:17 - \'Ember\' is not defined. (no-undef)\n10:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n11:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n13:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n13:17 - \'Ember\' is not defined. (no-undef)\n13:17 - Use import { computed } from \'@ember/object\'; instead of using Ember.computed (ember/new-module-imports)\n14:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n15:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n16:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n17:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n18:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n19:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n21:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n21:20 - Use import { computed } from \'@ember/object\'; instead of using Ember.computed (ember/new-module-imports)\n21:20 - \'Ember\' is not defined. (no-undef)\n22:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n23:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n24:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)');
  });

  QUnit.test('helpers/is-current-page.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'helpers/is-current-page.js should pass ESLint\n\n');
  });

  QUnit.test('models/jobs.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/jobs.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/job-info.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/job-info.js should pass ESLint\n\n');
  });

  QUnit.test('routes/jobs.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/jobs.js should pass ESLint\n\n5:12 - Use import $ from \'jquery\'; instead of using Ember.$ (ember/new-module-imports)\n5:12 - \'Ember\' is not defined. (no-undef)\n10:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n11:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)');
  });
...
define('job-search-ember/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('job-search-ember/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'job-search-ember/templates/application.hbs should pass TemplateLint.\n\njob-search-ember/templates/application.hbs\n  2:1  error  Incorrect indentation for `<div>` beginning at L2:C1. Expected `<div>` to be at an indentation of 2 but was found at 1.  block-indentation\n  3:2  error  Incorrect indentation for `{{partial}}` beginning at L3:C2. Expected `{{partial}}` to be at an indentation of 3 but was found at 2.  block-indentation\n  3:2  error  Unexpected {{partial}} usage.  no-partial\n  7:2  error  Unexpected {{partial}} usage.  no-partial\n  3:12  error  you must use double quotes in templates  quotes\n  7:12  error  you must use double quotes in templates  quotes\n');
  });

  QUnit.test('job-search-ember/templates/footbar.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'job-search-ember/templates/footbar.hbs should pass TemplateLint.\n\njob-search-ember/templates/footbar.hbs\n  2:49  error  Incorrect indentation for `\xA9 2018 Armando Mossuto\n  ` beginning at L2:C49. Expected `\xA9 2018 Armando Mossuto\n  ` to be at an indentation of 4 but was found at 49.  block-indentation\n');
  });

  QUnit.test('job-search-ember/templates/index.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'job-search-ember/templates/index.hbs should pass TemplateLint.\n\njob-search-ember/templates/index.hbs\n  2:1  error  Incorrect indentation for `<div>` beginning at L2:C1. Expected `<div>` to be at an indentation of 2 but was found at 1.  block-indentation\n  3:2  error  Incorrect indentation for `<h2>` beginning at L3:C2. Expected `<h2>` to be at an indentation of 3 but was found at 2.  block-indentation\n  4:2  error  Incorrect indentation for `<h3>` beginning at L4:C2. Expected `<h3>` to be at an indentation of 3 but was found at 2.  block-indentation\n  5:2  error  Incorrect indentation for `<div>` beginning at L5:C2. Expected `<div>` to be at an indentation of 3 but was found at 2.  block-indentation\n  6:3  error  Incorrect indentation for `{{input}}` beginning at L6:C3. Expected `{{input}}` to be at an indentation of 4 but was found at 3.  block-indentation\n  7:3  error  Incorrect indentation for `{{input}}` beginning at L7:C3. Expected `{{input}}` to be at an indentation of 4 but was found at 3.  block-indentation\n  8:3  error  Incorrect indentation for `<button>` beginning at L8:C3. Expected `<button>` to be at an indentation of 4 but was found at 3.  block-indentation\n  8:34  error  you must use double quotes in templates  quotes\n');
  });

  QUnit.test('job-search-ember/templates/job-info.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'job-search-ember/templates/job-info.hbs should pass TemplateLint.\n\njob-search-ember/templates/job-info.hbs\n  2:1  error  Incorrect indentation for `<div>` beginning at L2:C1. Expected `<div>` to be at an indentation of 2 but was found at 1.  block-indentation\n  16:1  error  Incorrect indentation for `<div>` beginning at L16:C1. Expected `<div>` to be at an indentation of 2 but was found at 1.  block-indentation\n  3:2  error  Incorrect indentation for `{{#if}}` beginning at L3:C2. Expected `{{#if}}` to be at an indentation of 3 but was found at 2.  block-indentation\n  4:3  error  Incorrect indentation for `<img>` beginning at L4:C3. Expected `<img>` to be at an indentation of 4 but was found at 3.  block-indentation\n  7:4  error  Incorrect indentation for `<div>` beginning at L7:C4. Expected `<div>` to be at an indentation of 5 but was found at 4.  block-indentation\n  8:4  error  Incorrect indentation for `<div>` beginning at L8:C4. Expected `<div>` to be at an indentation of 5 but was found at 4.  block-indentation\n  13:4  error  Incorrect indentation for `<div>` beginning at L13:C4. Expected `<div>` to be at an indentation of 5 but was found at 4.  block-indentation\n  9:5  error  Incorrect indentation for `<div>` beginning at L9:C5. Expected `<div>` to be at an indentation of 6 but was found at 5.  block-indentation\n  10:5  error  Incorrect indentation for `<img>` beginning at L10:C5. Expected `<img>` to be at an indentation of 6 but was found at 5.  block-indentation\n  11:5  error  Incorrect indentation for `<div>` beginning at L11:C5. Expected `<div>` to be at an indentation of 6 but was found at 5.  block-indentation\n  17:2  error  Incorrect indentation for `<div>` beginning at L17:C2. Expected `<div>` to be at an indentation of 3 but was found at 2.  block-indentation\n  18:2  error  Incorrect indentation for `<div>` beginning at L18:C2. Expected `<div>` to be at an indentation of 3 but was found at 2.  block-indentation\n  4:3  error  img tags must have an alt attribute  img-alt-attributes\n  10:5  error  img tags must have an alt attribute  img-alt-attributes\n  17:8  error  Usage of triple curly brackets is unsafe  no-triple-curlies\n  18:47  error  Usage of triple curly brackets is unsafe  no-triple-curlies\n  4:3  error  Self-closing a void element is redundant  self-closing-void-elements\n  10:5  error  Self-closing a void element is redundant  self-closing-void-elements\n');
  });

  QUnit.test('job-search-ember/templates/jobs.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'job-search-ember/templates/jobs.hbs should pass TemplateLint.\n\njob-search-ember/templates/jobs.hbs\n  1:2  error  Incorrect indentation for `<div>` beginning at L1:C2. Expected `<div>` to be at an indentation of 0, but was found at 2.  block-indentation\n  29:9  error  Incorrect indentation for `div` beginning at L1:C2. Expected `</div>` ending at L29:C9 to be at an indentation of 2 but was found at 3.  block-indentation\n  2:3  error  Incorrect indentation for `{{#each}}` beginning at L2:C3. Expected `{{#each}}` to be at an indentation of 4 but was found at 3.  block-indentation\n  18:1  error  Incorrect indentation for `<nav>` beginning at L18:C1. Expected `<nav>` to be at an indentation of 4 but was found at 1.  block-indentation\n  3:4  error  Incorrect indentation for `<div>` beginning at L3:C4. Expected `<div>` to be at an indentation of 5 but was found at 4.  block-indentation\n  15:8  error  Incorrect indentation for `div` beginning at L3:C4. Expected `</div>` ending at L15:C8 to be at an indentation of 4 but was found at 2.  block-indentation\n  4:5  error  Incorrect indentation for `{{#if}}` beginning at L4:C5. Expected `{{#if}}` to be at an indentation of 6 but was found at 5.  block-indentation\n  7:5  error  Incorrect indentation for `<div>` beginning at L7:C5. Expected `<div>` to be at an indentation of 6 but was found at 5.  block-indentation\n  6:15  error  Incorrect indentation for `if` beginning at L4:C5. Expected `{{/if}}` ending at L6:C15 to be at an indentation of 5 but was found at 8.  block-indentation\n  5:10  error  Incorrect indentation for `<img>` beginning at L5:C10. Expected `<img>` to be at an indentation of 7 but was found at 10.  block-indentation\n  14:9  error  Incorrect indentation for `div` beginning at L7:C5. Expected `</div>` ending at L14:C9 to be at an indentation of 5 but was found at 3.  block-indentation\n  8:6  error  Incorrect indentation for `<div>` beginning at L8:C6. Expected `<div>` to be at an indentation of 7 but was found at 6.  block-indentation\n  9:4  error  Incorrect indentation for `<div>` beginning at L9:C4. Expected `<div>` to be at an indentation of 7 but was found at 4.  block-indentation\n  10:5  error  Incorrect indentation for `<div>` beginning at L10:C5. Expected `<div>` to be at an indentation of 6 but was found at 5.  block-indentation\n  11:5  error  Incorrect indentation for `<img>` beginning at L11:C5. Expected `<img>` to be at an indentation of 6 but was found at 5.  block-indentation\n  12:5  error  Incorrect indentation for `<div>` beginning at L12:C5. Expected `<div>` to be at an indentation of 6 but was found at 5.  block-indentation\n  28:9  error  Incorrect indentation for `nav` beginning at L18:C1. Expected `</nav>` ending at L28:C9 to be at an indentation of 1 but was found at 3.  block-indentation\n  19:4  error  Incorrect indentation for `<ul>` beginning at L19:C4. Expected `<ul>` to be at an indentation of 3 but was found at 4.  block-indentation\n  20:5  error  Incorrect indentation for `{{#each}}` beginning at L20:C5. Expected `{{#each}}` to be at an indentation of 6 but was found at 5.  block-indentation\n  21:6  error  Incorrect indentation for `{{#if}}` beginning at L21:C6. Expected `{{#if}}` to be at an indentation of 7 but was found at 6.  block-indentation\n  22:7  error  Incorrect indentation for `<li>` beginning at L22:C7. Expected `<li>` to be at an indentation of 8 but was found at 7.  block-indentation\n  24:7  error  Incorrect indentation for `<li>` beginning at L24:C7. Expected `<li>` to be at an indentation of 8 but was found at 7.  block-indentation\n  5:10  error  img tags must have an alt attribute  img-alt-attributes\n  11:5  error  img tags must have an alt attribute  img-alt-attributes\n  3:29  error  Interaction added to non-interactive element  no-invalid-interactive\n  24:50  error  Interaction added to non-interactive element  no-invalid-interactive\n  5:10  error  Self-closing a void element is redundant  self-closing-void-elements\n  11:5  error  Self-closing a void element is redundant  self-closing-void-elements\n');
  });

  QUnit.test('job-search-ember/templates/navbar.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'job-search-ember/templates/navbar.hbs should pass TemplateLint.\n\njob-search-ember/templates/navbar.hbs\n  2:1  error  Incorrect indentation for `<div>` beginning at L2:C1. Expected `<div>` to be at an indentation of 2 but was found at 1.  block-indentation\n  3:2  error  Incorrect indentation for `<div>` beginning at L3:C2. Expected `<div>` to be at an indentation of 3 but was found at 2.  block-indentation\n  4:3  error  Incorrect indentation for `<ul>` beginning at L4:C3. Expected `<ul>` to be at an indentation of 4 but was found at 3.  block-indentation\n  5:4  error  Incorrect indentation for `{{#link-to}}` beginning at L5:C4. Expected `{{#link-to}}` to be at an indentation of 5 but was found at 4.  block-indentation\n  6:4  error  Incorrect indentation for `{{#link-to}}` beginning at L6:C4. Expected `{{#link-to}}` to be at an indentation of 5 but was found at 4.  block-indentation\n  7:4  error  Incorrect indentation for `{{#link-to}}` beginning at L7:C4. Expected `{{#link-to}}` to be at an indentation of 5 but was found at 4.  block-indentation\n  8:4  error  Incorrect indentation for `{{#link-to}}` beginning at L8:C4. Expected `{{#link-to}}` to be at an indentation of 5 but was found at 4.  block-indentation\n  5:15  error  you must use double quotes in templates  quotes\n  6:15  error  you must use double quotes in templates  quotes\n  7:15  error  you must use double quotes in templates  quotes\n  8:15  error  you must use double quotes in templates  quotes\n');
  });

  QUnit.test('job-search-ember/templates/profile.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'job-search-ember/templates/profile.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('job-search-ember/templates/settings.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'job-search-ember/templates/settings.hbs should pass TemplateLint.\n\n');
  });
});
define('job-search-ember/tests/lint/tests.lint-test', [], function () {
  'use strict';

  QUnit.module('ESLint | tests');

  QUnit.test('integration/components/job-info-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/job-info-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/helpers/is-current-page-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/helpers/is-current-page-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/controllers/job-info-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/job-info-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/controllers/jobs-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/jobs-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/initializers/jobs-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/initializers/jobs-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/job-info-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/job-info-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/jobs-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/jobs-test.js should pass ESLint\n\n');
  });
...
define('job-search-ember/tests/test-helper', ['job-search-ember/app', 'job-search-ember/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('job-search-ember/tests/unit/controllers/index-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('job-search-ember/tests/unit/controllers/job-info-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Controller | job-info', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      let controller = this.owner.lookup('controller:job-info');
      assert.ok(controller);
    });
  });
});
define('job-search-ember/tests/unit/controllers/jobs-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Controller | jobs', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('job-search-ember/tests/unit/initializers/jobs-test', ['job-search-ember/initializers/jobs', 'qunit', 'ember-qunit'], function (_jobs, _qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Initializer | jobs', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('job-search-ember/tests/unit/routes/job-info-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | job-info', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:job-info');
      assert.ok(route);
    });
  });
});
define('job-search-ember/tests/unit/routes/jobs-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | jobs', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('job-search-ember/tests/unit/routes/profile-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('job-search-ember/tests/unit/routes/settings-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
require('job-search-ember/tests/test-helper');
